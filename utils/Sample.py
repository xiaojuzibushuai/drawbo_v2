...
from config import AccessKey_ID, AccessKey_Secret
...
class Sample:
    ...
    @staticmethod
    def send_sms(
         phone_numbers: str, sign_name: str, template_code: str, code: str,
    ) -> dict:
        ...
        client = Sample.create_client(AccessKey_ID, AccessKey_Secret)
        params = Sample.create_api_info()
        # query params
        queries = {}
        queries['PhoneNumbers'] = phone_numbers
        queries['SignName'] = sign_name
        queries['TemplateCode'] = template_code
        queries['TemplateParam'] = '{"code":%s}' % code
        # runtime options

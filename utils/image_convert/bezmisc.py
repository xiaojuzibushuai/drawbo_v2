...
def bezierparameterize(p):

    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = p
    #parametric bezier
    x0=bx0
    y0=by0
    cx=3*(bx1-x0)
...
def linebezierintersect(p1,p2):

    ((lx1,ly1),(lx2,ly2)) = p1
    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = p2
    #parametric line
    dd=lx1
    cc=lx2-lx1
    bb=ly1
...
def beziertatslope(p1,p2):
    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = p1
    (dy,dx) = p2
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def bezierlengthSimpson(p, tolerance = 0.001):
    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = p
...
def beziertatlength(p, l = 0.5, tolerance = 0.001):
    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = p
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy

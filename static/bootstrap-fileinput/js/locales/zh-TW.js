...
(function ($) {
    ...
    $.fn.fileinputLocales['zh-TW'] = {
        ...
        msgSizeTooSmall: '檔案 "{name}" (<d>{size} KB</d>) 必須大於限定大小 <d>{minSize} KB</d>.',
        msgSizeTooLarge: '檔案 "{name}" (<d>{size} KB</d>) 大小超過上限 <d>{maxSize} KB</d>.',
        msgFilesTooLess: '最少必須選擇 <d>{n}</d> {files} 來上傳. ',
        msgFilesTooMany: '上傳的檔案數量 <d>({n})</d> 超過最大檔案上傳限制 <d>{m}</d>.',
